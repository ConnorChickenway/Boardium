package xyz.connorchickenway.boardium.nms.v1_12_R1;
...
import static xyz.connorchickenway.boardium.util.ReflectionUtil.*;

public class ScoreboardPacket_v1_12_R1 extends ScoreboardBase {


    public ScoreboardPacket_v1_12_R1( Player player ) {
        super( player );
    }
    ...
    public Object createScorePacket( String scoreName , String objectiveName , int mode , int index ) {
        ...
        setField( packet , "d" , PacketPlayOutScoreboardScore.EnumScoreboardAction.values()[ mode ] );
        return packet;
    }
